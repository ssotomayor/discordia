...
3. **Set Up Your Environment**: `README.md` is the project overview; this file (`AGENTS.md`) is the setup/orientation doc. See "Build, run, test" above and `docs/SELF_HOSTING.md` for deploying a server.
